...
console.log("edited application module running");
		...
		function parseData(cb) {
			...
			function afterBodyParser()
			{
				...
				if(sig !== req.headers['x-twilio-signature'])
					cb(null, data);   // delete this line if the author can fix the bug
// edited out due to hash mismatch error 2012-09-01
